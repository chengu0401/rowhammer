...
sum += x; 
# 13
__asm__("ld.param.cv.u32 %0, [%1];" : "=r" (x) : "l" (addrs[a])); 
# 16
}  
# 17
}  
...
timer.Start(); 
# 62
(__cudaPushCallConfiguration(2, 1)) ? (void)0 : kernel(addrs, addr_count, toggles, mem, mem_size); 
# 63
timer.Stop(); 
# 64
...
# 127
test_opts opts = {10, 500000, 20, 268435456, 1, 1, 1, 0, ((char)255)}; 
# 128
int flag; 
# 129
...
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_cudahammer_test_cpp1_ii_ec0d1a0a
# 1 "cudahammer_test.cudafe1.stub.c"
